class script(object):
    START_TXT = """<b><u>🚩 ʜᴀʀ ʜᴀʀ ᴍᴀʜᴀᴅᴇᴠ 🚩</u></b>

<b>ʜᴇʏ {}, {}</b>

<b>🤖 ɪ ᴀᴍ <a href=https://t.me/{}>{}</a>, ᴛʜᴇ ᴍᴏsᴛ ᴘᴏᴡᴇʀғᴜʟ & ᴀᴅᴠᴀɴᴄᴇ ᴀɪ ᴘᴏᴡᴇʀᴇᴅ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ʙᴏᴛ. ɪᴛ's ᴇᴀsʏ ᴛᴏ ᴜsᴇ, ᴊᴜsᴛ sᴇɴᴅ ᴍᴏᴠɪᴇ ᴏʀ sᴇʀɪᴇs ɴᴀᴍᴇ ᴡɪᴛʜ ᴘʀᴏᴘᴇʀ ɢᴏᴏɢʟᴇ sᴘᴇʟʟɪɴɢ.!! ᴛʜᴇɴ sᴇᴇ ᴍʏ ᴍᴀɢɪᴄ ✨</b>
"""


    GSTART_TXT = """<b>🚩 ʜᴀʀ ʜᴀʀ ᴍᴀʜᴀᴅᴇᴠ 🚩</b>
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a>{file_caption}</a></b>\n\n<b>⚜️ Powered By : <a href="https://t.me/DPCBackup">[ ᴅᴘᴄʙᴀᴄᴋᴜᴘ ]</a></b>"""
...
<b>ʀᴇǫ ʙʏ : {message.from_user.mention}</b>"""
    ...
    PREMIUM_TEXT = """<blockquote>🎖️ <b>𝖠𝖵𝖠𝖨𝖫𝖠𝖡𝖫𝖤 𝖯𝖫𝖠𝖭𝖲</b></blockquote>

<b>▪️ 𝟼 ᴍᴏɴᴛʜs  : 𝟹𝟶𝟶/- ₹  / 𝟹𝟶𝟶 sᴛᴀʀ</b>
<b>▪️ 𝟷 ʏᴇᴀʀ       : 𝟻𝟶𝟶/- ₹  / 𝟻𝟶𝟶 sᴛᴀʀ</b>
•─────•─────────•─────•
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @DPCBackup_Support_Bot
...
BPREMIUM_TXT = """<blockquote>🎁 <b>𝖯𝖱𝖤𝖬𝖨𝖴𝖬 𝖬𝖮𝖵𝖨𝖤𝖲 𝖢𝖧𝖠𝖭𝖭𝖤𝖫</b> :</blockquote>

<b>✔️ Eɴᴊᴏʏ Aʟʟ Bᴇɴᴇғɪᴛs ᴏғ Fʀᴇᴇ Cʜᴀɴɴᴇʟ</b>
<b>✔️ Dɪʀᴇᴄᴛ Fɪʟᴇs Mᴏᴠɪᴇ Cʜᴀɴɴᴇʟ</b>
<b>✔️ Nᴏ Nᴇᴇᴅ Tᴏ Oᴘᴇɴ Lɪɴᴋs</b>
<b>✔️ Nᴏ Rᴇsᴛʀɪᴄᴛɪᴏɴs Oɴ Sᴀᴠɪɴɢ</b>
<b>✔️ Nᴏ Aᴜᴛᴏ Dᴇʟᴇᴛᴇ, Nᴏ Rᴇᴘᴇᴀᴛ</b>                      
<b>✔️ Uᴘʟᴏᴀᴅɪɴɢ Mᴏᴠɪᴇs Rᴇɢᴜʟᴀʀʟʏ</b>                     
<b>✔️ Pᴇʀᴍᴀɴᴇɴᴛ Cʜᴀɴɴᴇʟ (Nᴏ Bᴀɴ)</b>                                                                    
<b>✔️ Fᴜʟʟ Aᴅᴍɪɴ Sᴜᴘᴘᴏʀᴛ Dɪʀᴇᴄᴛʟʏ</b>                        
<b>✔️ Mᴏᴠɪᴇ Oɴ Rᴇǫᴜᴇsᴛ Fᴀᴄɪʟɪᴛʏ</b>                        
<b>✔️ Rᴇǫᴜᴇsᴛ Wɪʟʟ Bᴇ Cᴏᴍᴘʟᴇᴛᴇᴅ Iɴ 𝟷ʜ [ IF Aᴠᴀɪʟᴀʙʟᴇ ]</b>

<b>• ʏᴏᴜ ᴄᴀɴ ɢᴇᴛ ᴘʀᴇᴍɪᴜᴍ ʙʏ ʀᴇꜰᴇʀɪɴɢ ʏᴏᴜʀ ꜰʀɪᴇɴᴅꜱ ᴏʀ ʏᴏᴜ ᴄᴀɴ ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ ꜱᴇʀᴠɪᴄᴇ</b>

<b>➛ ᴜꜱᴇ /plan ᴛᴏ ꜱᴇᴇ ᴀʟʟ ᴏᴜʀ ᴘʟᴀɴꜱ ᴀᴛ ᴏɴᴄᴇ.</b>
<b>➛ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ ʙʏ ᴜꜱɪɴɢ : /myplan</b>
...
<blockquote>🎖 <b>𝖠𝖵𝖠𝖨𝖫𝖠𝖡𝖫𝖤 𝖯𝖫𝖠𝖭𝖲</b></blockquote>
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/DPCBackup_Support_Bot'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
